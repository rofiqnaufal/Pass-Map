...
#Create the filter
datafilter=data.loc[(data["Event"]=="Pressure")] #| (data["Event"]=="Interception") | (data["Event"]=="Recovery") | (data["Event"]=="Tackle (successful)") | (data["Event"]=="Tackle (failed)") | (data["Event"]=="Aerial duel (successful)") | (data["Event"]=="Aerial duel (failed)")]

#Pass Origin heatmap
x=datafilter["X"]
y=datafilter["Y"]

#Pass Endpoint heatmap
# x=datafilter["X2"]
# y=datafilter["Y2"]
